...
public class TiendaFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        llayout = (LinearLayout) rootView.findViewById(R.id.presslayout);
        buttonBurger.setOnClickListener(this);
        llayout.setOnClickListener(this);

        String nombre = getArguments().getString("nombre");
        txtNombre = (TextView) rootView.findViewById(R.id.txt_nombre);
        txtNombre.setText(nombre);

        String direccion = getArguments().getString("direccion");
        txtDireccion = (TextView) rootView.findViewById(R.id.txt_direccion);
